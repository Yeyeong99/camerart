...
function resultFirst(){
    backGround.style.backgroundImage="url('./img/plasticheavylover.png')";
    ...
    document.getElementById('download').setAttribute('href', './img/result1.png')
}
function resultSecond(){
    backGround.style.backgroundImage="url('./img/plasticbestfriend.png')";
    ...
    document.getElementById('download').setAttribute('href', './img/result2.png')
}
function resultThird(){
    backGround.style.backgroundImage="url('./img/plasticconsumer.png')";
    ...
    document.getElementById('download').setAttribute('href', './img/result3.png')
}
function resultFourth(){
    backGround.style.backgroundImage="url('./img/treeprotecter.png')";
    ...
    document.getElementById('download').setAttribute('href', './img/result4.png')
}
function resultFifth(){
    backGround.style.backgroundImage = "url('./img/forestprotecter.png')";
    ...
    document.getElementById('download').setAttribute('href', './img/result5.png')
}
function resultSixth(){
    backGround.style.backgroundImage = "url('./img/earthprotecter.png')";
    ...
    document.getElementById('download').setAttribute('href', './img/result6.png')
}
    ...
    optionBtn[i].addEventListener("click", function (e) {
        ...
        if (click !== 3) {
            ...
            if(e.target.innerHTML === "한국인은 역시 배달이지…"+"<br>"+"시켜먹는다.") {
                ...
                document.getElementById('four').style.backgroundImage="url('./img/salad.gif')"
                optionBtn[1].classList.add("hide");
                ...
                document.getElementById('four').style.backgroundImage="url('./img/cook.gif')";
